  ...
  return (
    <div className="px-5 sm:px-8 py-6 sm:py-8 bg-white mt-8 mb-4 rounded p-4">
      ...
      <div className="mt-4 space-y-2 px-3 py-3 text-sm sm:text-base leading-relaxed">
        <p>芝浦工業大学情報通信工学課程情報工学コース在籍</p>
        <p>大学に入ってからプログラミング学習をはじめ、現在バックエンド領域に大変興味を持っています。</p>
        <p>学習ベースで進めてたので現在はあまりプロダクトがないのですが、一か月に一本くらいはデプロイできればなと思っています。</p>
        <p>プログラミング一緒に学習する人とかも探してます！</p>
        <p></p>
      </div>
    </div>
  )
